...
namespace libEDJournalMonitor
{
    public partial class Commander
    {
        ...
        public float CargoSpace { get; internal set; } = 0;     // set from reading ship loadout events
        public EDLogCargoItem[] Inventory { get; internal set; }
        public EDLogMaterials Materials { get; internal set; }

        public EDLogMissions Missions { get; internal set; }
